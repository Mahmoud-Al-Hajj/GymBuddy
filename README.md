...
- [GymBuddy – Workout Tracking Mobile App](#gymbuddy---workout-tracking-mobile-app)
  - [Key Features](#key-features)
    - [Workout Management](#workout-management)
    - [Personal Records (PRs)](#personal-records-prs)
    - [Progress Tracking](#progress-tracking)
    - [Rest Timer Features](#rest-timer-features)
...
- [GymBuddy Server – Backend (Deployed)](#gymbuddy-server---backend-deployed)
  - [Overview](#overview)
  ...
  - [Database Schema](#database-schema)
    ...
    - [Personal Bests Table](#personal-bests-table)
    - [Progress Photos Table](#progress-photos-table)
  ...
  - [Development](#development)
    ...
    - [View Database (Prisma Studio)](#view-database-prisma-studio)
  - [Troubleshooting](#troubleshooting)
    - [Database Connection Error](#database-connection-error)
    - [JWT Token Invalid](#jwt-token-invalid)
